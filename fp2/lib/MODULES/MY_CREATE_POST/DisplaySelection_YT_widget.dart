...
class DisplaySelectionYT_widget<T> extends StatefulWidget {
  final headingText;
  const DisplaySelectionYT_widget({required this.headingText});

  @override
  _DisplaySelectionYT_widgetState<T> createState() =>
      _DisplaySelectionYT_widgetState<T>();
}

class _DisplaySelectionYT_widgetState<T>
    extends State<DisplaySelectionYT_widget<T>> {
            ...
            children: [
              ...
              Flex(
                ...
                children: [
                  Flexible(
                    flex: 3,
                    child: customTextFieldUi(lovedFact_controller,
                        'Share your thoughts', Icons.favorite),
                  ),
    ...
    return Padding(
        ...
        child: ClipRRect(
            ...
            child: Container(
              ...
              child: SizedBox(
                height: 190,
                // MyComponents.screenSize(context).height * 0.23,
